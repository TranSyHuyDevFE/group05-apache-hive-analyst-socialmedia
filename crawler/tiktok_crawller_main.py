...
class TikTokCrawlerMain:
    ...
    def load_trend_videos_crawled_by_category(self, category_slug):
        ...
        if os.path.exists(trend_videos_path):
            ...
            return filtered_df.to_dict(orient='records')  # Convert DataFrame to array of JSON objects
        else:
    ...
    def run(self):
        ...
        target_conf_path = self.io.duplicate_config(self.io.get_default_config_path(),  self.io.build_folder())
